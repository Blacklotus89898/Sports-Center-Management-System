...
public class InstructorServiceTests {
    ...
    public void testCreateInstructor() {
        ...
        byte[] image = instructor.getImage();
        ...
        when(instructorRepository.findInstructorByEmail(email)).thenReturn(null);
                ...
                // act
                createdInstructor = instructorService.createInstructor(email, password, name, image);
                ...
                assertEquals(instructor.getImage(), createdInstructor.getImage());
            }
            ...
            public void testCreateInstructorNullEmail() {
                ...
                SCSException exception = assertThrows(SCSException.class, () -> {
                    instructorService.createInstructor(email, password, name, image);
                });
            ...
            public void testGetInstructorById() {
                ...
                assertArrayEquals(instructor.getImage(), foundInstructor.getImage());
            ...
            public void testGetAllInstructors() {
                ...
                assertArrayEquals(instructors.get(0).getImage(), foundInstructors.get(0).getImage());
            ...
            public void testUpdateInstructor() {
                ...
                // act
                updatedInstructor = instructorService.updateInstructor(id, email, password, name, image);
                ...
                assertArrayEquals(image, updatedInstructor.getImage());
            }
            ...
            public void testUpdateInstructorNotFound() {
                ...
                // act
                SCSException exception = assertThrows(SCSException.class, () -> {
                    instructorService.updateInstructor(id, email, password, name, image);
                });
