...
public class InstructorIntegrationTests {
    ...
    public void testCreateInstructor() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, NAME, EMAIL, PASSWORD);
    ...
    public void testCreateInstructorInvalidEmail() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, NAME, "invalid email", PASSWORD);
    ...
    public void testCreateInstructorInvalidPassword() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, NAME, EMAIL, "");
    ...
    public void testCreateInstructorInvalidName() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, "", EMAIL, PASSWORD);
    ...
    public void testCreateInstructorDuplicateEmail() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, "any name", EMAIL, PASSWORD);
    ...
    public void testUpdateInstructor() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, "Jane Doe", "newemail@gmail.com", "newpassword");
    ...
    public void testUpdateInstructorInvalidEmail() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, "Jane Doe", "invalid email", "newpassword");
    ...
    public void testUpdateInstructorInvalidPassword() {
        // set up
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, "Jane Doe", EMAIL, "");
    ...
    public void testUpdateInstructorEmailExists() {
        // set up
        InstructorRequestDto existingInstructorRequestDto = new InstructorRequestDto(-1, "Jane Doe", "newnewemail@gmail.com", "random password");
        ...
        InstructorRequestDto instructorRequestDto = new InstructorRequestDto(-1, "Jane Doe", existingInstructorResponse.getBody().getEmail(), "newpassword");
    ...
    public void testDeleteAllInstructorsAndGetAllInstructors() {
        ...
        instructorRequestDto = new InstructorRequestDto(-1, NAME, "ranodom@gmail.com", PASSWORD);
        client.postForEntity("/instructors", instructorRequestDto, InstructorResponseDto.class);
        instructorRequestDto = new InstructorRequestDto(-1, NAME, "raaornstm@gmail.com", PASSWORD);
        client.postForEntity("/instructors", instructorRequestDto, InstructorResponseDto.class);
