...
public class ClassRegistrationServiceTests {
    ...
    public void setup() {
        ...
        Customer customer = new Customer(id1, date1, name1, email1, password1, null);
        ...
        Customer customer2 = new Customer(id3, date3, name3, email3, password3, null);
    ...
    public void testGetAllClassRegistrations() {
        ...
        ClassRegistration classRegistration2 = new ClassRegistration(6, customerService.getCustomerById(2), this.specificClass);
            ...
            public void testGetClassRegistrationsByClassId() {
                ...
                ClassRegistration classRegistration = new ClassRegistration(registrationId, new Customer(accountId, null, null, null, null, null), this.specificClass);
                ClassRegistration classRegistration1 = new ClassRegistration(registrationId + 1, new Customer(accountId + 1, null, null, null, null, null), this.specificClass);
                ClassRegistration classRegistration2 = new ClassRegistration(registrationId + 2, new Customer(accountId + 2, null, null, null, null, null), this.specificClass);
            ...
            public void testCreateClassRegistrationClassFull() {
                ...
                SpecificClass specificClass = new SpecificClass(1234, "Yoga with Bob", "Bring your own mat", Date.valueOf("2020-01-01"), Time.valueOf("10:00:00"), 3, 50, 50, 10.00, new ClassType("Yoga", "Come relax with some yoga", true, "icon.png"), new Schedule(2020), null);
            ...
            public void testUpdateClassRegistrationClassFull() {
                ...
                SpecificClass specificClass = new SpecificClass(1234, "Yoga with Bob", "Bring your own mat", Date.valueOf("2020-01-01"), Time.valueOf("10:00:00"), 3, 50, 50, 10.00, new ClassType("Yoga", "Come relax with some yoga", true, "icon.png"), new Schedule(2020), null);
                SpecificClass specificClass2 = new SpecificClass(1235, "Yoga with Amy", "Bring your own mat", Date.valueOf("2020-01-01"), Time.valueOf("10:00:00"), 3, 50, 50, 10.00, new ClassType("Yoga", "Come relax with some yoga", true, "icon.png"), new Schedule(2020), null);
            ...
            public void testCreateClassRegistrationCustomerAlreadyRegistered()  {
                ...
                SpecificClass specificClass = new SpecificClass(1234, "Yoga with Bob", "Bring your own mat", Date.valueOf("2020-01-01"), Time.valueOf("10:00:00"), 3, 50, 15, 10.00, new ClassType("Yoga", "Come relax with some yoga", true, "icon.png"), new Schedule(2020), null);
                Customer customer = new Customer(accountId, null, null, null, null, null);
                ClassRegistration classRegistration = new ClassRegistration(registrationId, customer, specificClass);
