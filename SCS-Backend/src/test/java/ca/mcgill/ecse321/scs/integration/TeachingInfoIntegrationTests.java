...
public class TeachingInfoIntegrationTests {
    ...
    public void createInstructorAndSpecificClass() {
        ...
        // instructorRequestDto2.setId(ACCOUNT_ID + 1);
        // instructorRequestDto2.setName(NAME);
        // instructorRequestDto2.setEmail(EMAIL);
        ...
        classTypeRequestDto.setDescription(CLASS_TYPE_DESCRIPTION);
        classTypeRequestDto.setIsApproved(IS_APPROVED);
        ...
        scheduleRequestDto.setYear(YEAR);
