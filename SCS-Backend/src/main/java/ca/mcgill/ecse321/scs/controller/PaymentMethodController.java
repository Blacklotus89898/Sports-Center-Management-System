...
public class PaymentMethodController {
     ...
     */
    @GetMapping(value = { "/paymentMethod/paymentId/{paymentId}", "/paymentMethod/paymentId/{paymentId}/" })
    public PaymentMethodResponseDto getPaymentMethodById(@PathVariable int paymentId) {
        return new PaymentMethodResponseDto(paymentMethodService.getPaymentMethod(paymentId));
    }
    ...
    public PaymentMethodResponseDto createPaymentMethod(@RequestBody PaymentMethodRequestDto paymentMethodDto) {
        ...
        String customerEmail = paymentMethodDto.getCustomer().getEmail();
    ...
    public PaymentMethodResponseDto updateCustomHours(@PathVariable int paymentId, @RequestBody PaymentMethodRequestDto paymentMethodDto) {
        long cardNumber = paymentMethodDto.getCardNumber();
        int expiryMonth = paymentMethodDto.getExpiryMonth();
        int expiryYear = paymentMethodDto.getExpiryYear();
        int securityCode = paymentMethodDto.getSecurityCode();
        ...
        PaymentMethod paymentMethod = paymentMethodService.updatePaymentMethod(paymentId, cardNumber, expiryMonth, expiryYear, securityCode, customerEmail);
        return new PaymentMethodResponseDto(paymentMethod);
    }
